      ...
      <div class="col-md-6">
        ...
        <div class="media">
          <div class="media-left">
            <img src="../upload/user upload/<?php $loc="user-".$user.$user_row['user_photo']; echo $loc; ?>" class="media-object" style="width: 128px; height: 128px;">
          </div>
          <div class="media-body">
            <h2 class="media-heading"><?php echo $user_row['first_name']; echo " "; echo $user_row['last_name'];?></h2>
            <p>Status: <?php echo $data_row['status'];?></p><br><p> Location: <?php echo $data_row['location'];?>,&nbsp; Badge: <?php echo $data_row['badge'];?></p>
          </div>
        </div>
        <!-- user profile -->
        ...
        <div>
          ...
          <?php
            ...
            $feed=mysqli_query($conn,"select * from user_post where user_id='$user'");
          ...
          <div class="panel panel-default">
            ...
            <div class="panel-footer">
              <span>You posted on <?php echo $feed_row['date'];?></span> 
